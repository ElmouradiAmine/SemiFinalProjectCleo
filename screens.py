...
class MenuScreen:
    def __init__(self,screen):
        ...
        self.imagesPath = [ 'assets/PlayButton.png','assets/LoginButton.png', 'assets/PlayButton.png','assets/ExitButton.png' ]
...
class PlaynowScreen:
    def __init__(self,screen):
        ...
        self.imagesPathEffect = [ 'assets/PlayButtonEffect.png','assets/PlayButtonEffect.png', 'assets/SignUpButtonEffect.png','assets/ExitButtonEffect.png', 'assets/SmallButtons/MoveLeftButton.png']
...
class SignupScreen:
    def __init__(self,screen):
        ...
        self.buttonLogin = Button('SIGNUP','assets/PlayButton.png','assets/SignUpButtonEffect.png')
